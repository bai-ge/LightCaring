...
public class ProgressBall extends View {
	public static final String TAG = ProgressBall.class.getCanonicalName();
	...
	private void init(Context context, AttributeSet attrs){
        init();
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ProgressBall);
        mColor = typedArray.getColor(R.styleable.ProgressBall_dot_color, 0xFFF05B72);
    }
