...
public class AppConfigure {
    ...
    public final static String KEY_PSW = "key_psw";
    public final static String KEY_UID = "key_uid";

    public final static String KEY_SELECT_USERNAME = "key_select_username";
    public final static String KEY_SELECT_UID = "key_select_uid";
    public final static String KEY_SELECT_DEVICE_ID = "key_select_device_id";

    public final static String KEY_GUIDE_PAGE = "key_guide_page";

    public final static String KEY_SERVER_IP = "key_phone_server_ip";
    ...
    public static final String KEY_CURRENT_LAT = "key_curent_lat";
    public static final String KEY_CURRENT_LON = "key_current_lon";
